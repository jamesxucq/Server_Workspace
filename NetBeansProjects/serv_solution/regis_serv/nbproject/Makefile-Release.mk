...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/regis_serv: ${OBJECTFILES}
	...
	${LINK.c} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/regis_serv ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${OBJECTDIR}/_ext/57abf465/linked_status.o: ../serv_common/linked_status.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/57abf465
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/57abf465/linked_status.o ../serv_common/linked_status.c
...
${OBJECTDIR}/_ext/57abf465/regis_xml.o: ../serv_common/regis_xml.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/57abf465
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/57abf465/regis_xml.o ../serv_common/regis_xml.c
...
${OBJECTDIR}/_ext/57abf465/server_list.o: ../serv_common/server_list.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/57abf465
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/57abf465/server_list.o ../serv_common/server_list.c

${OBJECTDIR}/_ext/57abf465/settings_xml.o: ../serv_common/settings_xml.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/57abf465
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/57abf465/settings_xml.o ../serv_common/settings_xml.c
...
${OBJECTDIR}/regis_serv.o: regis_serv.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/regis_serv.o regis_serv.c

${OBJECTDIR}/rserv_bzl.o: rserv_bzl.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/rserv_bzl.o rserv_bzl.c

${OBJECTDIR}/rserv_object.o: rserv_object.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/rserv_object.o rserv_object.c

${OBJECTDIR}/sdtp_utility.o: sdtp_utility.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sdtp_utility.o sdtp_utility.c
