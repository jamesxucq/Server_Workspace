...
# C Compiler Flags
CFLAGS=-Wall -D_AUTH_CACHE -D_DEBUG -D_LARGEFILE64_SOURCE
...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/auth_cache: ${OBJECTFILES}
	...
	${LINK.c} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/auth_cache ${OBJECTFILES} ${LDLIBSOPTIONS} -lxml2 -lstdc++ -lz -lpthread -lm -lc -lrt -lmysqlclient -L/usr/lib64/mysql -ldl
...
${OBJECTDIR}/_ext/57abf465/auth_cache.o: ../serv_common/auth_cache.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/57abf465
	${RM} "$@.d"
	$(COMPILE.c) -g -I. -I../serv_common -I../third_party -I/usr/include/mysql -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/57abf465/auth_cache.o ../serv_common/auth_cache.c
...
${OBJECTDIR}/_ext/57abf465/list_xml.o: ../serv_common/list_xml.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/57abf465
	${RM} "$@.d"
	$(COMPILE.c) -g -I. -I../serv_common -I../third_party -I/usr/include/mysql -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/57abf465/list_xml.o ../serv_common/list_xml.c

${OBJECTDIR}/_ext/57abf465/query_xml.o: ../serv_common/query_xml.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/57abf465
	${RM} "$@.d"
	$(COMPILE.c) -g -I. -I../serv_common -I../third_party -I/usr/include/mysql -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/57abf465/query_xml.o ../serv_common/query_xml.c
...
${OBJECTDIR}/_ext/57abf465/status_xml.o: ../serv_common/status_xml.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/57abf465
	${RM} "$@.d"
	$(COMPILE.c) -g -I. -I../serv_common -I../third_party -I/usr/include/mysql -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/57abf465/status_xml.o ../serv_common/status_xml.c
...
${OBJECTDIR}/aserv_bzl.o: aserv_bzl.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -I. -I../serv_common -I../third_party -I/usr/include/mysql -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/aserv_bzl.o aserv_bzl.c

${OBJECTDIR}/aserv_object.o: aserv_object.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -I. -I../serv_common -I../third_party -I/usr/include/mysql -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/aserv_object.o aserv_object.c
...
${OBJECTDIR}/cache_serv.o: cache_serv.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -I. -I../serv_common -I../third_party -I/usr/include/mysql -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/cache_serv.o cache_serv.c
...
${OBJECTDIR}/serve_bzl.o: serve_bzl.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -I. -I../serv_common -I../third_party -I/usr/include/mysql -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/serve_bzl.o serve_bzl.c
