...
${OBJECTDIR}/dires_xml.o: dires_xml.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/dires_xml.o dires_xml.c

${OBJECTDIR}/fatt_xml.o: fatt_xml.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/fatt_xml.o fatt_xml.c
...
${OBJECTDIR}/recu_directory.o: recu_directory.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/recu_directory.o recu_directory.c

${OBJECTDIR}/recu_utility.o: recu_utility.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/recu_utility.o recu_utility.c
