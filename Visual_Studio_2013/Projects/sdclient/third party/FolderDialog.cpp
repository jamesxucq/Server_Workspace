...
int CFolderDialog::OnValidateFailed(LPCTSTR lpstrFolderPath) {
	int result = AfxMessageBox(_T("The path entered is not valid! Continue ?"), MB_YESNO|MB_ICONQUESTION|MB_DEFBUTTON2);
											   ...
											   UINT uMsg, LPARAM lParam, LPARAM lpData)
{
	...
	case BFFM_VALIDATEFAILED:
		result = pThisDialog->OnValidateFailed((LPCTSTR)lParam);
		break;
	}
