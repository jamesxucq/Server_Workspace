...
BOOL InstallService::SCMCheckServiceExist(LPCWSTR sServiceName) {
    SC_HANDLE hSCManager; // Handle to the service control manager
    SC_HANDLE hService;// Handle to the service to be stopped
    // SERVICE_STATUS ss;
...
BOOL InstallService::KillService(LPCWSTR sServiceName) {
...
BOOL InstallService::InstallServiceEx(LPCWSTR sServFileName, // 驱动程序完整路径名称
