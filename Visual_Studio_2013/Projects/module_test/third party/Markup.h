...
#define MCD_CHAR TCHAR
#define MCD_PCSZ const TCHAR*
...
#endif // not VC++ safe strings
#define MCD_T(s) L ## s
#if MARKUP_SIZEOFWCHAR == 4 // sizeof(TCHAR) == 4
...
// On Linux and OS X, filenames are not specified in TCHAR
...
public:
	...
	MCD_STR GetAttrib( MCD_CSTR csAttrib ) const { return x_GetAttrib(m_iPos,csAttrib); };
	MCD_STR GetChildAttrib( MCD_CSTR csAttrib ) const { return x_GetAttrib(m_iPosChild,csAttrib); };
	...
	bool AddAttrib( MCD_CSTR csAttrib, MCD_CSTR szValue ) { return x_SetAttrib(m_iPos,csAttrib,szValue); };
	bool AddChildAttrib( MCD_CSTR csAttrib, MCD_CSTR szValue ) { return x_SetAttrib(m_iPosChild,csAttrib,szValue); };
	bool AddAttrib( MCD_CSTR csAttrib, int nValue ) { return x_SetAttrib(m_iPos,csAttrib,nValue); };
	bool AddChildAttrib( MCD_CSTR csAttrib, int nValue ) { return x_SetAttrib(m_iPosChild,csAttrib,nValue); };
	...
	bool RemoveNode();
	bool SetAttrib( MCD_CSTR csAttrib, MCD_CSTR szValue, int nFlags=0 ) { return x_SetAttrib(m_iPos,csAttrib,szValue,nFlags); };
	bool SetChildAttrib( MCD_CSTR csAttrib, MCD_CSTR szValue, int nFlags=0 ) { return x_SetAttrib(m_iPosChild,csAttrib,szValue,nFlags); };
	bool SetAttrib( MCD_CSTR csAttrib, int nValue, int nFlags=0 ) { return x_SetAttrib(m_iPos,csAttrib,nValue,nFlags); };
	bool SetChildAttrib( MCD_CSTR csAttrib, int nValue, int nFlags=0 ) { return x_SetAttrib(m_iPosChild,csAttrib,nValue,nFlags); };
