...
class kMutex {
 ...
 public:
  ...
  enum Type {
    ...
    kRECURSIVE            ///< allow recursive locking
  };
  /**
   * Default constructor.
   */
...
class ScopedMutex {
 public:
   ...
   */
  explicit ScopedMutex(kMutex* mutex) : mutex_(mutex) {
    _assert_(mutex);
    mutex_->lock();
  }
  /**
...
class CondVar {
 public:
   ...
   */
  bool wait(kMutex* mutex, double sec);
  /**
