...
BEGIN_MESSAGE_MAP(CDESTestDlg, CDialog)
	...
	ON_WM_QUERYDRAGICON()
	//}}AFX_MSG_MAP
	ON_BN_CLICKED(IDC_BUTTON1, &CDESTestDlg::OnBnClickedButton1)
END_MESSAGE_MAP()
...
void CDESTestDlg::OnBnClickedButton1()
{
	// TODO: 在此添加控件通知处理程序代码
	char *p="dfadgadfgafsgadfgafgadfgadfg";
	char buffer[64];

base64_encode(buffer, 64, (const unsigned char *)p, strlen(p));

base64_decode((unsigned char *)buffer, buffer, 64);

}

void CDESTestDlg::OnOK()
{
...
BOOL CDESTestDlg::PreTranslateMessage(MSG* pMsg)
{
	// TODO: 在此添加专用代码和/或调用基类
