 ...
 * Try to get the lock.
 */
bool kMutex::lock_try(double sec) {
 ...
 * Wait for the signal.
 */
void CondVar::wait(kMutex* mutex) {
#if defined(_SYS_MSVC_) || defined(_SYS_MINGW_)
  _assert_(mutex);
  CondVarCore* core = (CondVarCore*)opq_;
 ...
 * Wait for the signal.
 */
bool CondVar::wait(kMutex* mutex, double sec) {
#if defined(_SYS_MSVC_) || defined(_SYS_MINGW_)
